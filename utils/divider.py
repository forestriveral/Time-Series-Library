...
def dataset_divider(data_len, data_idx, ):
    split_part_num = 12
    val_part_num = 2
    test_part_num = 1
    data_idx = data_idx - 1
    ...
    # train_points = np.delete(split_points, np.arange(data_idx, data_idx + val_part_num + test_part_num + 1))
    ...
    elif data_idx >= split_part_num - val_part_num - test_part_num:
...
if __name__ == '__main__':
    border1s, border2s = dataset_divider(35136, 1)
